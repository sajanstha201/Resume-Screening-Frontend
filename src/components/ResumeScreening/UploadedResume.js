export const UploadedResume=()=>{
    return(
        <div className='h-[60%] flex flex-col shadow-md items-center justify-center '>
                ...
                <div className="h-[70%] w-[80%] flex-wrap overflow-auto border border-2 border-blue-400 rounded-md">
                </div>
                <div className="flex gap-2 m-2">
                    <button  className="w-28 h-10 bg-red-500 rounded-md border-2 border border-black shadow-sm">Remove All</button>
                    <button  className="w-28 h-10 bg-blue-500 rounded-md border-2 border border-black shadow-sm">Submit</button>
                </div>
        </div>
    )
}